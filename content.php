		...
		<header class="entry-header">
			<?php if ( is_sticky() ) : ?>
				<hgroup>
					...
					<h3 class="entry-format"><?php _e( 'Featured', 'animetfk' ); ?></h3>
				</hgroup>
			<?php else : ?>
			<h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'animetfk' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
			<?php endif; ?>
